...
@dataclass
class SearchResult:
    stage: str          # "news" | "search" | "deep_search" | "unknown"
    query: str
...
class TieredSearcher:
    """Runs news → web search → deep search, stopping at first relevant result.
    ...
    def search(self, article: Article) -> SearchResult:
        ...
        # Stage 3 — deep search (rewritten query, past month)
